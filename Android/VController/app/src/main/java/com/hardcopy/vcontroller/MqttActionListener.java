 ...
 * {@link org.eclipse.paho.android.service.MqttAndroidClient} and updating the {@link Connection} associated with
 * the action
 */
public class MqttActionListener implements IMqttActionListener {
    ...
    private IMqttActionCallback actionCallback;
    ...
    public MqttActionListener(Context context, Action action,
                              String clientHandle, IMqttActionCallback cb,
    ...
    private void connect() {
        Connection c = Connections.getInstance(context).getConnection(clientHandle);
        String actionTaken = context.getString(R.string.toast_connected) + c.getId();
